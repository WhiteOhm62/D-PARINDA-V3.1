    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className=" bg-blue-50 py-5 border border-blue-100 rounded-lg flex items-center justify-between">
                    <h1 className=" text-center text-xl lg:2xl font-bold text-blue-500 ml-10">Admin Dashboard</h1>
                      {/* logout button */}
                        
                      <button
                            onClick={logout}
                            type='button'
                            className='bg-blue-400 hover:bg-blue-500 w-20 text-white text-center p-2 font-bold rounded-md mr-5 '
                        >
                            Log Out
                        </button>
                </div>
