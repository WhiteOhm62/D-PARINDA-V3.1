    ...
    return (
        <div>
            <div className='flex justify-center items-center h-screen'>
                {loading && <Loader />}
                {/* Login Form  */}
                <div className="login_Form bg-blue-50 w-[90%] lg:w-[23%] px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                    {/* Top Heading  */}
                    <div className="mb-5">
                    ...
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-blue-50 border text-blue-300 border-blue-200 px-2 py-2 w-72 rounded-md outline-none placeholder-blue-300'
                        />
                    </div>
                    {/* Input Two  */}
                    <div className="mb-3">
