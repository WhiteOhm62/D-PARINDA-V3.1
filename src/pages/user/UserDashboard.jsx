    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 ">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-blue-50 py-5 rounded-xl border border-blue-100 flex overflow-x-hidden lg:flex-col ">
                        {/* image  */}
                        <div className="flex justify-center">
                            <img src="https://cdn-icons-png.flaticon.com/128/2202/2202112.png" className="ml-5 mr-5 w-20 h-20" alt="" />
                        </div>
                        {/* text  */}
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        {/* text  */}
                        <h2 className=" text-2xl lg:text-3xl font-bold">Your Orders\</h2>
                                                    ...
                                                    <div className="p-4">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            <div className="mb-4">
                                                                ...
                                                                <div className="text-sm font-medium text-gray-900">#{id.slice(0,10)}...</div>
                                                            </div>
