    ...
    return (
        <Layout>
            <div className="mt-10">
                {/* Heading  */}
                <div className="">
                    <h1 className=" text-center mb-5 text-2xl font-semibold first-letter:uppercase mt-5">{categoryname}</h1>
                </div>
                                ...
                                <div className="flex flex-wrap -m-4  justify-center">
                                    {filterProduct.length > 0
                                        ...
                                        <div>
                                            ...
                                            <h1 className=" text-black text-xl mt-8">No Products found related to {categoryname}</h1>
                                        </div>
                                    }
                                </div>
                            </div>
